...
class prac1 {
    public static void main(String args[]) {
        ...
        // Liters per 100 KM
        double litersPer100Km = (liters * 100) / distance;
        litersPer100Km = Math.round(litersPer100Km * 100.0) / 100.0;

        // Miles per gallon (with precise conversion factors)
        double miles = distance * 0.621371;   // 1 km = 0.621371 miles
        double gallons = liters * 0.264172;   // 1 liter = 0.264172 gallons
        double milesPerGallon = miles / gallons;
        milesPerGallon = Math.round(milesPerGallon * 100.0) / 100.0;
